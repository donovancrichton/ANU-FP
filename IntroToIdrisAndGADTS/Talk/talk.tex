...
\begin{itemize}
  \item GADTs now typecheck our object language expressions in our meta langauge.
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Reification and Reflection: Haskell has two langauges!
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item More instances of Functor, Applicatives, Monoids and Monads!
    \item IO (Finally!)
